(function () {
  let userToken = localStorage.getItem("chatbot_token");  // ✅ Get chatbot_token from localStorage

  if (!userToken) {
    console.error("No chatbot_token found. Please log in first.");
    return;
  }
  ...
  function sendMessage(message) {
    fetch("https://your-rails-app.com/api/v1/chat", {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${userToken}`,  // ✅ Use chatbot_token
